...
library(readxl)
library(dplyr)
iclaims <- read_excel("C:/Users/MFY/Desktop/data inc project/Bayesian Structured Time Series Data.xlsx",sheet = "Train")
glimpse(iclaims)
```
...
Lets also see its trend and seasonality!s
